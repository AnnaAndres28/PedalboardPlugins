/*******************************************************************************
 ...
 name:             UniqueDistortionPlugin
 version:          1.0.0
 vendor:           JUCE
 website:          https://oshe.io
 description:      unique distortion audio plugin.
 lastUpdated:	   March 28 2025 by Anna Andres
 ...
 type:             AudioProcessor
 mainClass:        UniqueDistortionProcessor
...
public:
                                           ...
                                           .withOutput ("Output", juce::AudioChannelSet::stereo()))
    {
        ...
        addParameter (percentDrop4 = new juce::AudioParameterFloat({ "percentDrop4", 1 }, "Sample Drop Percent (Mode 4)", 0.0f, 10.0f, 0.5f));
    }
    ...
    void processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer&) override
    {
        ...
        auto lthres2 = highthres2->get();
        float lowThreshold = 0.05f / lthres2;
        float highThreshold = 0.05f / hthres2;
        ...
        float wavefoldThreshold = 0.05f / hthres2;
        ...
        switch(modeValue) {
            case 1: // harsher type of distortion essentially using a triangle wave
                ...
                break;
            case 2: // pause distortion - self made
                for (int channel = 0; channel < buffer.getNumChannels(); ++channel) {
                    auto* channelData = buffer.getWritePointer(channel);
                    for (int sample = 0; sample < buffer.getNumSamples(); ++sample) {
                        float processedSample = channelData[sample] * gainValue; // applying gain
    ...
    //==============================================================================
    const juce::String getName() const override                  { return "Unique Distortion PlugIn"; }
    ...
    void getStateInformation (juce::MemoryBlock& destData) override
    {
        ...
        juce::MemoryOutputStream (destData, true).writeFloat (*percentDrop4);
    }
    ...
    void setStateInformation (const void* data, int sizeInBytes) override
    {
        ...
        percentDrop4->setValueNotifyingHost (juce::MemoryInputStream (data, static_cast<size_t> (sizeInBytes), false).readFloat());
    }
...
private:
    ...
    juce::AudioParameterFloat* percentDrop4;

    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (UniqueDistortionProcessor)
};
